...
- `SchneeBarExternalWidgets`: strict data-only external-widget document adapter. Depends on Core and normalizes documents into existing widget models without adding execution, network, or filesystem capabilities.
